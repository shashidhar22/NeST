...
#Generate SNP Freq report and figure for novel exonic variants, synonymous
...
write_csv(tbl.ex.syn, "novel_SNPs_exonic_syn.csv", col_names = T)
...
file2 <- "novel_SNPs_exonic_syn.csv"
...
write.csv(table1,"Novel_SNPs_Report_exonic_syn.csv")

### bar graph of Table 1
pdf("Novel_SNPs_exonic_syn.pdf",width = 10,height = 15)
